    ...
    <div className="min-h-screen bg-gray-100 pt-20">
      ...
      <div className="bg-secondary-700 text-white py-8 px-4 sm:px-6 lg:px-8 mb-6">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-2xl font-bold mb-1">Equipe</h1>
          <p className="text-gray-400">Gere ton equipe et suis ta progression</p>
        </div>
      </div>
        ...
        {!loading && !error && (
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1">
              ...
              {userTeam ? (
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  {/* En-tete de l'equipe */}
                  <div className="bg-secondary-700 px-6 py-5">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-gray-400 text-sm font-medium mb-1">Mon equipe</p>
                        <h2 className="text-xl font-bold text-white">{userTeam.name}</h2>
                      </div>
                      {getUserTeamRank() && (
                        <div className="bg-secondary-600 rounded-lg px-4 py-2 text-center">
                    ...
                    {userTeam.description && (
                      <p className="text-gray-400 mt-3 text-sm">{userTeam.description}</p>
                    )}
                  </div>
                  ...
                  <div className="p-5">
                    <div className="grid grid-cols-2 gap-4 mb-5">
                      <div className="bg-gray-50 rounded-lg p-4 text-center border border-gray-100">
                        <div className="w-9 h-9 mx-auto mb-2 rounded-lg bg-secondary-700 flex items-center justify-center">
                          <svg className="w-4 h-4 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                          </svg>
                        </div>
                        <p className="text-2xl font-bold text-secondary-700">{userTeam.members_count || 0}</p>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 text-center border border-gray-100">
                        ...
                        <p className="text-2xl font-bold text-secondary-700">{(userTeam.total_distance || 0).toFixed(1)} <span className="text-sm font-normal">km</span></p>
                    ...
                    <div className="border-t border-gray-100 pt-5">
                      <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Activite recente</h3>
                      <div className="bg-gray-50 rounded-lg p-4 text-center text-gray-500 text-sm border border-gray-100">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  {!showCreateForm ? (
                    ...
                    <div className="text-center py-6">
                      <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-secondary-700 flex items-center justify-center">
                        <svg className="w-7 h-7 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                      </div>
                      <h2 className="text-lg font-bold text-secondary-700 mb-2">Tu n'as pas encore d'equipe</h2>
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 bg-secondary-700 text-white font-medium rounded-lg hover:bg-secondary-600 transition-colors"
                      >
                        Creer une equipe
                      </button>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-5">
                        <h2 className="text-lg font-bold text-secondary-700">Creer une equipe</h2>
                        <button
                          onClick={() => {
                            setShowCreateForm(false);
                            setCreateError(null);
                      ...
                      <form onSubmit={handleCreateTeam} className="space-y-4">
                        ...
                        {/* Nom */}
                        <div>
                          <label htmlFor="teamName" className="block text-sm font-medium text-secondary-700 mb-1">
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 rounded-lg border border-gray-200 focus:border-secondary-500 focus:outline-none focus:ring-2 focus:ring-secondary-500/20 transition-all text-secondary-700 placeholder:text-gray-400"
                          />
                        ...
                        {/* Description */}
                        <div>
                          <label htmlFor="teamDescription" className="block text-sm font-medium text-secondary-700 mb-1">
                          ...
                          <textarea
                            ...
                            className="w-full px-3 py-2 rounded-lg border border-gray-200 focus:border-secondary-500 focus:outline-none focus:ring-2 focus:ring-secondary-500/20 transition-all text-secondary-700 placeholder:text-gray-400 resize-none"
                          />
                        ...
                        <div className="flex gap-3 pt-2">
                          ...
                          <button
                            ...
                            className="flex-1 px-4 py-2 bg-secondary-700 text-white font-medium rounded-lg hover:bg-secondary-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                          >
            ...
            <div className="lg:w-64">
              <div className="bg-secondary-700 rounded-xl p-4 sticky top-24">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-7 h-7 rounded-lg bg-secondary-600 flex items-center justify-center">
                    <svg className="w-4 h-4 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {teams.length === 0 ? (
                  <p className="text-sm text-gray-400 text-center py-4">Aucune equipe</p>
                ) : (
                      ...
                      return (
                        <div
                          ...
                          className={`flex items-center gap-2 p-2 rounded-lg transition-colors ${
                            isUserTeam ? 'bg-primary-500/20' : 'hover:bg-secondary-600'
                          }`}
                        >
                          <span className={`w-5 text-center font-bold text-sm ${
                            index < 3 ? 'text-base' : 'text-gray-500'
                          }`}>
                            {getPositionBadge(index + 1)}
                          </span>
                          <div className="flex-1 min-w-0">
                            <p className={`text-sm font-medium truncate ${
                              isUserTeam ? 'text-primary-400' : 'text-white'
                            }`}>
                              {team.name}
                            </p>
