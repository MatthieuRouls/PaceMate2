    ...
    <div className="min-h-screen bg-neu-base">
      <div className="max-w-[1280px] mx-auto px-8 pt-28 pb-24">
        ...
        <section className="mb-14">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-dark-800 via-dark-700 to-dark-900 p-8 min-h-[240px]">
            {/* Background effects */}
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-4 mb-8">
                      <div className="flex -space-x-2">
                        {[...Array(Math.min(featuredSession.participants_count || 3, 5))].map((_, i) => (
                          <div
                            key={i}
                            className="w-9 h-9 rounded-full bg-gradient-to-br from-pink-400 to-purple-500 border-2 border-dark-800 flex items-center justify-center text-xs font-bold text-white"
                          >
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white font-bold text-lg rounded-2xl shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40 hover:-translate-y-0.5 transition-all duration-200"
                    >
                      Rejoindre la sortie
                ...
                <div className="bg-dark-900/60 backdrop-blur-sm rounded-2xl p-5 w-full max-w-[220px] border border-white/5">
                  ...
                  <div className="h-1.5 bg-dark-600 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${level >= 9 ? 100 : Math.min(95, level * 11)}%` }}
                    />
                  </div>
                </div>
              </div>
          ...
          <section className="mb-14">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              {secondarySessions[0] && (
                ...
                >
                  <div className="h-full bg-white rounded-3xl p-7 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-200 border border-silver-100">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <span className="text-sm text-dark-500">{formatDate(secondarySessions[0].start_time)}</span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-dark-500 mb-6">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex -space-x-2">
                          {[...Array(Math.min(secondarySessions[0].participants_count || 2, 3))].map((_, i) => (
                            <div
                              key={i}
                              className="w-8 h-8 rounded-full bg-gradient-to-br from-neon-400 to-teal-500 border-2 border-white flex items-center justify-center text-xs font-bold text-white"
                            >
                              {String.fromCharCode(65 + i)}
                            </div>
                          ))}
              ...
              <div className="flex-[4] flex flex-col gap-4">
                {secondarySessions.slice(1).map((session) => (
                  <Link
                    ...
                    className="group bg-white rounded-2xl p-5 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 border border-silver-100"
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <ChevronRight className="w-4 h-4 text-dark-400 group-hover:text-pink-500 group-hover:translate-x-0.5 transition-all" />
                    </div>
                ...
                {secondarySessions.length < 3 && (
                  <Link
                    href="/sessions"
                    className="flex-1 flex items-center justify-center gap-2 bg-silver-50 rounded-2xl p-5 text-dark-500 hover:text-dark-700 hover:bg-silver-100 transition-colors border-2 border-dashed border-silver-200"
                  >
                    <Plus className="w-5 h-5" />
        ...
        <section className="mb-14">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            {/* Activity Feed (60%) */}
            <div className="flex-[6] bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden">
              <div className="divide-y divide-silver-100">
                {[
                  { user: 'Marie L.', action: 'a rejoint', target: 'Sortie matinale Paris 15e', time: 'Il y a 2h' },
                  { user: 'Thomas R.', action: 'a cree', target: 'Fractionne au Bois de Vincennes', time: 'Il y a 4h' },
                  { user: 'Sophie M.', action: 'a termine', target: '10 km en 48:32', time: 'Hier' },
                ].map((item, i) => (
                  <div key={i} className="px-6 py-4 flex items-center gap-4 hover:bg-silver-50 transition-colors">
            ...
            <div className="flex-[4]">
              {userTeam ? (
                <Link href="/teams" className="block h-full group">
                  <div className="h-full bg-gradient-to-br from-dark-800 to-dark-900 rounded-2xl p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-200">
                    ...
                    <div className="flex items-center gap-4 mb-5">
                      <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-500 to-neon-600 flex items-center justify-center text-white text-xl font-bold">
                ...
                <Link href="/teams" className="block h-full group">
                  <div className="h-full bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl p-6 flex flex-col justify-center items-center text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-200">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link href="/sessions" className="group bg-white/70 rounded-2xl p-5 hover:bg-white hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <Link href="/teams" className="group bg-white/70 rounded-2xl p-5 hover:bg-white hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <Link href="/sessions/create" className="group bg-white/70 rounded-2xl p-5 hover:bg-white hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
      ...
      <Link
        href="/sessions/create"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-5 py-4 bg-pink-500 hover:bg-pink-600 text-white font-bold rounded-2xl shadow-lg shadow-pink-500/30 hover:shadow-pink-500/50 hover:-translate-y-0.5 transition-all duration-200"
      >
