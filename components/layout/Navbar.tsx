              ...
              <div className="relative">
                ...
                {dropdownOpen && (
                  <>
                    ...
                    />
                    <div className="absolute right-0 top-14 w-56 bg-white rounded-xl shadow-xl border border-silver-400 py-2 z-50">
                      <Link
                        href="/profile"
                        onClick={() => setDropdownOpen(false)}
                        className="flex items-center gap-3 px-4 py-3 text-sm text-dark-800 hover:bg-silver-100 transition-colors"
                      >
                      ...
                      <div className="my-2 border-t border-silver-300" />
                      <button
                        onClick={handleSignOut}
                        className="flex items-center gap-3 px-4 py-3 text-sm text-rust-600 hover:bg-rust-50 w-full transition-colors"
                      >
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`px-5 py-2 font-medium transition-colors ${
                  scrolled ? 'text-dark-800 hover:text-petrol-700' : 'text-white hover:text-sand-400'
                }`}
              >
                Connexion
              </button>
