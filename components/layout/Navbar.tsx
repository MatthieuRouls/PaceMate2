                ...
                {dropdownOpen && (
                  <>
                    ...
                    <div className="absolute right-0 top-14 w-56 bg-white dark:bg-dark-700 rounded-xl shadow-xl border border-silver-400 dark:border-dark-600 py-2 z-50">
                      ...
                      >
                        <svg className="w-5 h-5 text-petrol-700 dark:text-petrol-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="flex items-center gap-3 px-4 py-3 text-sm text-rust-600 hover:bg-rust-50 dark:hover:bg-rust-900/30 w-full transition-colors"
                      >
