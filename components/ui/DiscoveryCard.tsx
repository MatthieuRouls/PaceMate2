...
import { MapPin, Clock, Users, Shield, Zap, ChevronRight, Flame } from 'lucide-react';
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center gap-1.5 text-[11px] text-dark-200">
          ...
          {session.distance_from_user != null && (
            <span className="text-neon-400 font-semibold shrink-0">
              {session.distance_from_user} km
            </span>
          )}
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {(session.hasCoRunner || session.isTeamRun) && (
            <span className="text-[10px] px-1.5 py-0.5 bg-neon-500/10 border border-neon-500/30 text-neon-400 rounded-full font-medium">
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between text-[11px]">
            ...
            <span className={`font-bold ${fillPct >= 70 ? 'text-orange-400' : 'text-dark-400'}`}>
              {fillPct}%
            </span>
          </div>
