      ...
      <div className="space-y-5">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-neon-100 text-neon-700">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 text-dark-600">
            <div className="w-9 h-9 rounded-lg bg-neon-100 flex items-center justify-center flex-shrink-0">
              <svg className="w-4 h-4 text-neon-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-3">
            <div className="flex -space-x-2">
              ...
              {Array.from({ length: Math.min(2, (session.participants_count || 1) - 1) }).map((_, i) => (
                <div
                  key={i}
                  className="w-9 h-9 rounded-full bg-silver-400 border-2 border-white"
                />
              ))}
            </div>
